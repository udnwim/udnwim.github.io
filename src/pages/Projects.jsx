  ...
  return (
    <>
      ...
      <div className="text-left sm:text-base md:text-lg px-8 pb-15">
        <CollapsibleSection title='Pomodoro Timer' navbarRef={navbarRef}>
          <div className='flex flex-col justify-center w-full'>
            <img src={timer} className='mx-auto mt-4 w-60 sm:w-xs max-w-xs'/>
            <a href="https://udnwim.github.io/Pomodoro-Timer1/" target='_blank' className='
              text-center text-lg w-xs mt-4 mx-auto rounded
              bg-[#4C4444]
              hover:text-[#F3CD89] 
            ...
            <p className='px-4 text-center'>A responsive web application using JavaScript, HTML, and CSS that implemented a Pomodoro timer to enhance user productivity and time management.</p>
          </div>
        </CollapsibleSection>
        <CollapsibleSection title="Webpage Color Inspiration" navbarRef={navbarRef}>
          <div className="flex flex-col justify-center relative group">
            <img src={pearl} alt="img" className='w-60 mx-auto sm:w-xs max-w-xs' />
            <p className='text-center'>Girl with a Pearl Earring - Johannes Vermeer</p>
          </div>
        </CollapsibleSection>
